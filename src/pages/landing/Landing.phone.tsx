...
export const LandingPhone = () => {
  return (
    <div className="flex w-[319px] h-[616px] items-center justify-center absolute top-0 left-0 right-0 bottom-0 m-auto overflow-hidden">
      <div
      ...
      <div className="absolute h-full m-auto left-0 right-0">
        <img className="h-full object-cover" src={PhoneImage} />
      </div>
...
const Title = forwardRef<HTMLSpanElement, TitleProps>((_, ref) => {
  return (
    <span
      className="text-white font-normal font-galmuri9 leading-normal whitespace-nowrap"
      ref={ref}
    >
      우리집 고양이가
      <br />
...
const PlayButtonLabel = forwardRef<HTMLDivElement, PlayButtonLabelProps>(
  (_, ref) => {
    return (
      <div className="w-[200px] mt-[32px]" ref={ref}>
...
const PlayButton = forwardRef<HTMLButtonElement, PlayButtonProps>(
  ({ ...restProps }, ref) => {
    return (
      <button className="w-[80px] mt-[4px]" ref={ref} {...restProps}>
